# Logistic Regression Multiclass Classifier in Scikit-Learn with LIME explanations
## Project Description
...
- A **Logistic Regression** algorithm for multiclass classification built using **SciKit-Learn**
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the Logistic Regression Multiclass Classifier model implemented using **Scikit-Learn** library.
